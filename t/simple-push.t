...
#         $openbug = $1;
#     }
#     diag( "As bob, the last changeset I've seen from alice is "
#           . $bob->last_changeset_from_source( $alice->uuid ) );
...
#         my %args = (@_);
#         return
#           unless $args{changeset}->has_changes, push @{$new_changesets},
#           $args{changeset}->as_hash;
#       }

# );

# is(
#     delete $new_changesets->[0]->{'sequence_no'},
...
# is_deeply( $new_changesets, $expected );
